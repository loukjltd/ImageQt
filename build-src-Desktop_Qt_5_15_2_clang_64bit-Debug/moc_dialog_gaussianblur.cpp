/****************************************************************************
** Meta object code from reading C++ file 'dialog_gaussianblur.h'
**
...
#include <memory>
#include "../src/dialog/dialog_gaussianblur.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'dialog_gaussianblur.h' doesn't include <QObject>."
...
void GaussianBlurDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GaussianBlurDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendData((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        ...
        {
            using _t = void (GaussianBlurDialog::*)(int , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GaussianBlurDialog::sendData)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GaussianBlurDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_GaussianBlurDialog.data,
    qt_meta_data_GaussianBlurDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void GaussianBlurDialog::sendData(int _t1, double _t2)
{
